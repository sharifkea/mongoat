...
{   
    public function test_create(){
        ...
        $sec=array('txtMurl'=>'mongodb+srv://ronysharif:rony2204@sharifmdb.px3qb.mongodb.net/?retryWrites=true&w=majority','document'=>'rdms','collection'=>'testColl');
    ...
    public function test_strInArray(){
        $array=array('txtMurl'=>'mongodb://localhost:27017','document'=>'newdb','collection'=>'test');
        $key='newdb';
